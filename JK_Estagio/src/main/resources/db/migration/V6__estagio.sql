...
INSERT INTO `aluno` VALUES (2,'Kaio','(21) 9999-9999','Noturno',1,3),(3,'Mariah','(99) 9999-9999','Noturno',1,3),(4,'Alisson','(21) 6465-4040','Noturno',1,1);
...
INSERT INTO `aluno_vaga` VALUES (2,1),(2,2);
...
INSERT INTO `empresa` VALUES (1,'Faetec','faetec1@gmail.com'),(2,'Nike','nike1teste@gmail.com');
...
CREATE TABLE `vaga` (
  ...
  CONSTRAINT `fk_vaga_curso` FOREIGN KEY (`curso_id`) REFERENCES `curso` (`id_curso`),
...
INSERT INTO `vaga` VALUES (1,'Suporte','33','5',1,'Jardim América',3),(2,'Programador','6','4',2,'Cordovil',3),(3,'Assistente','133',NULL,1,'Cordovil',1);
...
-- Dump completed on 2024-06-12 17:45:13
